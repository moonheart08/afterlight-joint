...
using Content.Shared._AnchorLane.Time;
...
namespace Content.Client.PDA
{
    ...
    public sealed partial class PdaMenu : PdaWindow
    {
        ...
        private readonly WorldTimeSystem _worldTime; // AL EDIT
        ...
        public PdaMenu()
        {
            ...
            _worldTime = _entitySystem.GetEntitySystem<WorldTimeSystem>(); // AL EDIT
        ...
        public void UpdateState(PdaUpdateState state)
        {
            ...
            StationTimeLabel.SetMarkup(Loc.GetString("comp-pda-ui-station-time",
                ("time", _worldTime.Now().ToString()))); // AL EDIT: Changed to world time.
